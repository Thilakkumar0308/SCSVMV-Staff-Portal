...
// Allow Admin/DeptAdmin/HOD full access, Teacher view-only
if (!has_role('Admin') && !has_role('DeptAdmin') && !has_role('HOD') && !has_role('Teacher')) {
    redirect('dashboard.php');
}

$is_teacher = has_role('Teacher');
...
// Handle Add/Edit/Delete (Teachers blocked)
if (!$is_teacher && $_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['action'])) {
...
<div class="card shadow-sm mb-4">
  <div class="card-body">
    <div class="row g-3">
     ...
     <!-- Add Student Button (hidden for Teachers) -->
<?php if (!$is_teacher): ?>
  <div class="col-12 col-md-3 d-flex align-items-end justify-content-md-end">

    <!-- Add Student -->
    <button type="button" class="btn btn-primary w-100 w-md-auto me-2" 
