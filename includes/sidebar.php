...
<div class="col-md-3 col-lg-2 d-md-block bg-light sidebar">
    <div class="position-sticky pt-3">
        <ul class="nav flex-column">
            ...
            <!-- Teacher-Class Assignment: Admin + HOD -->
            <?php if (has_role('Admin') || has_role('HOD')): ?>
            <li class="nav-item">
                <a class="nav-link <?php echo basename($_SERVER['PHP_SELF']) == 'teacher_classes.php' ? 'active' : ''; ?>" href="teacher_classes.php">
                    <i class="fas fa-chalkboard-teacher me-2"></i>Teacher-Class Assignment
                </a>
            </li>
            <?php endif; ?>
